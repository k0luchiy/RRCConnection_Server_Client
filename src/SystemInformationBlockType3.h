...
typedef struct SystemInformationBlockType3 {
	...
	struct SystemInformationBlockType3__ext9 {
		struct CellReselectionServingFreqInfo_v1610	*cellReselectionServingFreqInfo_v1610;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext9;
	struct SystemInformationBlockType3__ext10 {
		TimeOffsetUTC_r17_t	*t_Service_r17;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_SystemInformationBlockType3_1[14];
