...
typedef enum ReportConfigEUTRA__ext10__coarseLocationReq_r17 {
	ReportConfigEUTRA__ext10__coarseLocationReq_r17_true	= 0
} e_ReportConfigEUTRA__ext10__coarseLocationReq_r17;
...
typedef struct ReportConfigEUTRA {
	...
	struct ReportConfigEUTRA__ext4 {
		...
		BOOLEAN_t	*useAllowedCellList_r13;	/* OPTIONAL */
	...
	struct ReportConfigEUTRA__ext9 {
	...
	struct ReportConfigEUTRA__ext10 {
		BOOLEAN_t	*includeUncomBarPreMeas_r17;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_coarseLocationReq_r17_123;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_ReportConfigEUTRA;
extern asn_SEQUENCE_specifics_t asn_SPC_ReportConfigEUTRA_specs_1;
extern asn_TYPE_member_t asn_MBR_ReportConfigEUTRA_1[16];
