...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_DCCH_MessageType__c1, choice.dlDedicatedMessageSegment_r16),
...
static const asn_TYPE_tag2member_t asn_MAP_c1_tag2el_2[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 13, 0, 0 }, /* dlDedicatedMessageSegment-r16 */
