...
static asn_per_constraints_t asn_PER_type_serviceType_r15_constr_3 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_serviceType_r15_value2enum_3[] = {
	{ 0,	3,	"qoe" },
	{ 1,	7,	"qoemtsi" },
	{ 2,	6,	"spare6" },
	{ 3,	6,	"spare5" },
...
static const unsigned int asn_MAP_serviceType_r15_enum2value_3[] = {
	0,	/* qoe(0) */
	1,	/* qoemtsi(1) */
	7,	/* spare1(7) */
	6,	/* spare2(6) */
...
static const asn_INTEGER_specifics_t asn_SPC_serviceType_r15_specs_3 = {
	asn_MAP_serviceType_r15_value2enum_3,	/* "tag" => N; sorted by tag */
	asn_MAP_serviceType_r15_enum2value_3,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_serviceType_r15_tags_3[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_serviceType_r15_3 = {
	"serviceType-r15",
	"serviceType-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_serviceType_r15_tags_3,
	sizeof(asn_DEF_serviceType_r15_tags_3)
		/sizeof(asn_DEF_serviceType_r15_tags_3[0]) - 1, /* 1 */
	asn_DEF_serviceType_r15_tags_3,	/* Same as above */
	sizeof(asn_DEF_serviceType_r15_tags_3)
		/sizeof(asn_DEF_serviceType_r15_tags_3[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_serviceType_r15_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_serviceType_r15_specs_3	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_MeasReportAppLayer_r15_IEs_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MeasReportAppLayer_r15_IEs, serviceType_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_serviceType_r15_3,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
