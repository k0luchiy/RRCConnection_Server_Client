...
/* Dependencies */
typedef enum CRS_AssistanceInfo_r15__crs_IntfMitigEnabled_r15 {
	CRS_AssistanceInfo_r15__crs_IntfMitigEnabled_r15_enabled	= 0
} e_CRS_AssistanceInfo_r15__crs_IntfMitigEnabled_r15;

/* CRS-AssistanceInfo-r15 */
typedef struct CRS_AssistanceInfo_r15 {
	PhysCellId_t	 physCellId_r15;
	long	*crs_IntfMitigEnabled_r15;	/* OPTIONAL */
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_crs_IntfMitigEnabled_r15_3;	// (Use -fall-defs-global to expose) */
