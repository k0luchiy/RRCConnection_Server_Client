...
typedef struct MobilityControlInfo {
	...
	struct MobilityControlInfo__ext5 {
		struct DAPS_Config_r16	*daps_Config_r16;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_MobilityControlInfo_1[13];
