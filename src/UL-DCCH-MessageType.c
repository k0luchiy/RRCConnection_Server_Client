...
static asn_TYPE_member_t asn_MBR_c2_20[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_DCCH_MessageType__messageClassExtension__c2, choice.purConfigurationRequest_r16),
		(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_DCCH_MessageType__messageClassExtension__c2, choice.failureInformation_r16),
		(ASN_TAG_CLASS_CONTEXT | (13 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_c2_tag2el_20[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 11, 0, 0 }, /* ulDedicatedMessageSegment-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (12 << 2)), 12, 0, 0 }, /* purConfigurationRequest-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 13, 0, 0 }, /* failureInformation-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (14 << 2)), 14, 0, 0 }, /* mcgFailureInformation-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (15 << 2)), 15, 0, 0 } /* ulInformationTransferIRAT-r16 */
};
