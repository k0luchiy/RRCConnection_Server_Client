...
asn_TYPE_member_t asn_MBR_UEAssistanceInformation_v1610_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct UEAssistanceInformation_v1610_IEs, overheatingAssistance_v1610),
...
static const int asn_MAP_UEAssistanceInformation_v1610_IEs_oms_1[] = { 0, 1 };
...
static const asn_TYPE_tag2member_t asn_MAP_UEAssistanceInformation_v1610_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* overheatingAssistance-v1610 */
