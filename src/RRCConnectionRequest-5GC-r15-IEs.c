...
asn_TYPE_member_t asn_MBR_RRCConnectionRequest_5GC_r15_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionRequest_5GC_r15_IEs, ue_Identity_r15),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionRequest_5GC_r15_IEs, establishmentCause_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_RRCConnectionRequest_5GC_r15_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-Identity-r15 */
