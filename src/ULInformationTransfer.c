...
static asn_TYPE_member_t asn_MBR_c1_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ULInformationTransfer__criticalExtensions__c1, choice.ulInformationTransfer_r16),
...
static const asn_TYPE_tag2member_t asn_MAP_c1_tag2el_3[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ulInformationTransfer-r16 */
