...
typedef enum MAC_MainConfig__ext10__ce_ETWS_CMAS_RxInConn_r16 {
	MAC_MainConfig__ext10__ce_ETWS_CMAS_RxInConn_r16_true	= 0
} e_MAC_MainConfig__ext10__ce_ETWS_CMAS_RxInConn_r16;
typedef enum MAC_MainConfig__ext11__offsetThresholdTA_r17_PR {
	MAC_MainConfig__ext11__offsetThresholdTA_r17_PR_NOTHING,	/* No components present */
	MAC_MainConfig__ext11__offsetThresholdTA_r17_PR_release,
	MAC_MainConfig__ext11__offsetThresholdTA_r17_PR_setup
} MAC_MainConfig__ext11__offsetThresholdTA_r17_PR;
typedef enum MAC_MainConfig__ext11__sr_ProhibitTimerOffset_r17_PR {
	MAC_MainConfig__ext11__sr_ProhibitTimerOffset_r17_PR_NOTHING,	/* No components present */
	MAC_MainConfig__ext11__sr_ProhibitTimerOffset_r17_PR_release,
	MAC_MainConfig__ext11__sr_ProhibitTimerOffset_r17_PR_setup
} MAC_MainConfig__ext11__sr_ProhibitTimerOffset_r17_PR;
...
typedef struct MAC_MainConfig {
	...
	struct MAC_MainConfig__ext10 {
		long	*ce_ETWS_CMAS_RxInConn_r16;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext10;
	struct MAC_MainConfig__ext11 {
		struct MAC_MainConfig__ext11__offsetThresholdTA_r17 {
			MAC_MainConfig__ext11__offsetThresholdTA_r17_PR present;
			union MAC_MainConfig__ext11__offsetThresholdTA_r17_u {
				NULL_t	 release;
			...
			/* Context for parsing across buffer boundaries */
			asn_struct_ctx_t _asn_ctx;
		} *offsetThresholdTA_r17;
		struct MAC_MainConfig__ext11__sr_ProhibitTimerOffset_r17 {
			MAC_MainConfig__ext11__sr_ProhibitTimerOffset_r17_PR present;
			union MAC_MainConfig__ext11__sr_ProhibitTimerOffset_r17_u {
				NULL_t	 release;
...
/* extern asn_TYPE_descriptor_t asn_DEF_ce_ETWS_CMAS_RxInConn_r16_179;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_MAC_MainConfig;
extern asn_SEQUENCE_specifics_t asn_SPC_MAC_MainConfig_specs_1;
extern asn_TYPE_member_t asn_MBR_MAC_MainConfig_1[15];
