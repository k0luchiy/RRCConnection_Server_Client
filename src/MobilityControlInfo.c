...
static asn_TYPE_member_t asn_MBR_ext5_37[] = {
	{ ATF_POINTER, 1, offsetof(struct MobilityControlInfo__ext5, daps_Config_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext5_oms_37[] = { 0 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext5_specs_37 = {
	sizeof(struct MobilityControlInfo__ext5),
	offsetof(struct MobilityControlInfo__ext5, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MobilityControlInfo_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct MobilityControlInfo, rach_ConfigDedicated),
	...
	{ ATF_POINTER, 5, offsetof(struct MobilityControlInfo, ext1),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext1_19,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct MobilityControlInfo, ext2),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext2_21,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct MobilityControlInfo, ext3),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext3_24,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct MobilityControlInfo, ext4),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		0,
		&asn_DEF_ext4_34,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MobilityControlInfo, ext5),
		(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
		0,
		&asn_DEF_ext5_37,
		0,
...
static const int asn_MAP_MobilityControlInfo_oms_1[] = { 1, 2, 3, 7, 8, 9, 10, 11, 12 };
