...
typedef enum LogicalChannelConfig__ext4__channelAccessPriority_r15_PR {
	LogicalChannelConfig__ext4__channelAccessPriority_r15_PR_NOTHING,	/* No components present */
	LogicalChannelConfig__ext4__channelAccessPriority_r15_PR_release,
	LogicalChannelConfig__ext4__channelAccessPriority_r15_PR_setup
} LogicalChannelConfig__ext4__channelAccessPriority_r15_PR;
typedef enum LogicalChannelConfig__ext5__bitRateMultiplier_r16 {
	LogicalChannelConfig__ext5__bitRateMultiplier_r16_x40	= 0,
	LogicalChannelConfig__ext5__bitRateMultiplier_r16_x70	= 1,
	LogicalChannelConfig__ext5__bitRateMultiplier_r16_x100	= 2,
	LogicalChannelConfig__ext5__bitRateMultiplier_r16_x200	= 3
} e_LogicalChannelConfig__ext5__bitRateMultiplier_r16;
...
typedef struct LogicalChannelConfig {
	...
	struct LogicalChannelConfig__ext4 {
		...
		struct LogicalChannelConfig__ext4__channelAccessPriority_r15 {
			LogicalChannelConfig__ext4__channelAccessPriority_r15_PR present;
			union LogicalChannelConfig__ext4__channelAccessPriority_r15_u {
				NULL_t	 release;
				long	 setup;
			} choice;
	...
	struct LogicalChannelConfig__ext5 {
...
extern asn_TYPE_member_t asn_MBR_LogicalChannelConfig_1[6];
