...
asn_TYPE_member_t asn_MBR_InterFreqCarrierFreqInfo_r12_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct InterFreqCarrierFreqInfo_r12, interFreqExcludedCellList_r12),
...
static const asn_TYPE_tag2member_t asn_MAP_InterFreqCarrierFreqInfo_r12_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 13, 0, 0 }, /* interFreqExcludedCellList-r12 */
