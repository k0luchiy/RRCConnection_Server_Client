...
typedef enum RAN_NotificationAreaInfo_r15_PR {
	...
	RAN_NotificationAreaInfo_r15_PR_cellList,
	RAN_NotificationAreaInfo_r15_PR_ran_AreaConfigList
...
typedef struct RAN_NotificationAreaInfo_r15 {
	...
	union RAN_NotificationAreaInfo_r15_u {
		PLMN_RAN_AreaCellList_r15_t	 cellList;
		PLMN_RAN_AreaConfigList_r15_t	 ran_AreaConfigList;
	} choice;
