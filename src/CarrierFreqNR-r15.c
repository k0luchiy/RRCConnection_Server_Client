...
static asn_TYPE_member_t asn_MBR_ext2_32[] = {
	{ ATF_POINTER, 3, offsetof(struct CarrierFreqNR_r15__ext2, ns_PmaxListNR_v1760),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct CarrierFreqNR_r15__ext2, multiBandNsPmaxListNR_v1760),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		...
		0, 0, /* No default value */
		"multiBandNsPmaxListNR-v1760"
		},
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqNR_r15__ext2, multiBandNsPmaxListNR_SUL_v1760),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		...
		0, 0, /* No default value */
		"multiBandNsPmaxListNR-SUL-v1760"
		},
};
static const int asn_MAP_ext2_oms_32[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_ext2_tags_32[] = {
	(ASN_TAG_CLASS_CONTEXT | (20 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_32[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ns-PmaxListNR-v1760 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* multiBandNsPmaxListNR-v1760 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* multiBandNsPmaxListNR-SUL-v1760 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_32 = {
	sizeof(struct CarrierFreqNR_r15__ext2),
	offsetof(struct CarrierFreqNR_r15__ext2, _asn_ctx),
	asn_MAP_ext2_tag2el_32,
	3,	/* Count of tags in the map */
	asn_MAP_ext2_oms_32,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext2_32 = {
	"ext2",
	"ext2",
	&asn_OP_SEQUENCE,
	asn_DEF_ext2_tags_32,
	sizeof(asn_DEF_ext2_tags_32)
		/sizeof(asn_DEF_ext2_tags_32[0]) - 1, /* 1 */
	asn_DEF_ext2_tags_32,	/* Same as above */
	sizeof(asn_DEF_ext2_tags_32)
		/sizeof(asn_DEF_ext2_tags_32[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext2_32,
	3,	/* Elements count */
	&asn_SPC_ext2_specs_32	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_CarrierFreqNR_r15_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct CarrierFreqNR_r15, maxRS_IndexCellQual_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct CarrierFreqNR_r15, threshRS_Index_r15),
	...
	{ ATF_POINTER, 2, offsetof(struct CarrierFreqNR_r15, ext1),
		(ASN_TAG_CLASS_CONTEXT | (19 << 2)),
		0,
		&asn_DEF_ext1_28,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqNR_r15, ext2),
		(ASN_TAG_CLASS_CONTEXT | (20 << 2)),
		0,
		&asn_DEF_ext2_32,
		0,
...
static const int asn_MAP_CarrierFreqNR_r15_oms_1[] = { 1, 2, 3, 5, 6, 7, 10, 12, 14, 15, 17, 18, 19, 20 };
...
static const asn_TYPE_tag2member_t asn_MAP_CarrierFreqNR_r15_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (20 << 2)), 20, 0, 0 } /* ext2 */
};
