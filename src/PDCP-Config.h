...
typedef enum PDCP_Config__ext7__ethernetHeaderCompression_r16_PR {
	PDCP_Config__ext7__ethernetHeaderCompression_r16_PR_NOTHING,	/* No components present */
	PDCP_Config__ext7__ethernetHeaderCompression_r16_PR_release,
	PDCP_Config__ext7__ethernetHeaderCompression_r16_PR_setup
} PDCP_Config__ext7__ethernetHeaderCompression_r16_PR;
typedef enum PDCP_Config__ext8__discardTimerExt_r17_PR {
	PDCP_Config__ext8__discardTimerExt_r17_PR_NOTHING,	/* No components present */
	PDCP_Config__ext8__discardTimerExt_r17_PR_release,
	PDCP_Config__ext8__discardTimerExt_r17_PR_setup
} PDCP_Config__ext8__discardTimerExt_r17_PR;
...
typedef struct PDCP_Config {
	...
	struct PDCP_Config__ext7 {
		struct PDCP_Config__ext7__ethernetHeaderCompression_r16 {
			PDCP_Config__ext7__ethernetHeaderCompression_r16_PR present;
			union PDCP_Config__ext7__ethernetHeaderCompression_r16_u {
				NULL_t	 release;
	...
	struct PDCP_Config__ext8 {
		struct PDCP_Config__ext8__discardTimerExt_r17 {
			PDCP_Config__ext8__discardTimerExt_r17_PR present;
			union PDCP_Config__ext8__discardTimerExt_r17_u {
				NULL_t	 release;
...
extern asn_TYPE_member_t asn_MBR_PDCP_Config_1[12];
