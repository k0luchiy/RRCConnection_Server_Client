...
typedef enum MeasParameters_v1310__allowedCellList_r13 {
	MeasParameters_v1310__allowedCellList_r13_supported	= 0
} e_MeasParameters_v1310__allowedCellList_r13;
...
typedef struct MeasParameters_v1310 {
	...
	long	*allowedCellList_r13;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_allowedCellList_r13_4;	// (Use -fall-defs-global to expose) */
